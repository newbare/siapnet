...
<div id="div_conteudo">
  <fieldset><legend><b>| <label class="lbTituloLegend">Movimentação de bem tombado pelo patrimônio</label> |</b></legend>
    <fieldset>
      <b>Bem:</b> ${patrimonio.itemEntrada.item.nome}  <b>Marca:</b> ${patrimonio.marca.nome}  <b>Modelo:</b>${patrimonio.modelo}
      <br/><b>Número Tombamento:</b> ${patrimonio.numero}  <b>Estado Atual de Depreciação:</b> ${patrimonio.estadoDepreciacao.nome}
      <br/><b>Setor:</b> ${patrimonio.departamento.nome}  <b>Localizado em:</b> ${patrimonio.localizacao}
    </fieldset>
    <fieldset><legend>Movimentação</legend>
