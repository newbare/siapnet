...
<div id="div_conteudo">
    <fieldset><legend><b>| <label class="lbTituloLegend">Relatório de Consumo de Material</label> |</b></legend>
        <form method="post" action="geraRelatorio" accept-charset="utf-8" onsubmit="return validar();"  target="_blank">
            <table>
                <tr>            
                    ...
                    <td><label>Critério: </label></td>
                    <td><select name="relatorio" >
                            <option value="Consumo">Todos Setores</option>
                            <option value="ConsumoItens">Todos Itens</option>

                        </select></td>
                </tr>
                <tr ><td colspan="2" id="departamentos"></td></tr>
                <tr>
