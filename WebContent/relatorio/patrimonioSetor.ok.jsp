...
<div id="div_conteudo">
  <fieldset><legend><b>| <label class="lbTituloLegend">Relatório de Bens do Patrimônio por Setor</label> |</b></legend>
    <form method="post" action="geraRelatorio" accept-charset="utf-8" target="_blank"> 
      <input type="hidden" name="relatorio" value="PatrimonioSetor" />
