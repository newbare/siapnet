...
<div id="div_conteudo">
    <fieldset><legend><b>| <label class="lbTituloLegend">Relatório de notas de saída por período</label> |</b></legend>
        <form method="post" action="geraRelatorio" accept-charset="utf-8" onsubmit="return validar();"  target="_blank">
            <input type="hidden" name="relatorio" value="NotaSaida" />
            <table>
                <tr><td>
                        <label>Almoxarifado: </label></td><td>
