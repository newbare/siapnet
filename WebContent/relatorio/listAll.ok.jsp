    ...
    <div id="div_conteudo">
      ...
      <display:table id="relatorio" class="grid" name="relatorios" pagesize="10" requestURI="relatorio.listAll.logic">
	        ...
	        <display:column title="Titulo" property="titulo" sortable="true"/>
                <display:column title="Arquivo" property="arquivoJasper" sortable="true"/>
	        <display:column>
	        	<a href="relatorio.get.logic?relatorio.id=${relatorio.id}"><img src="images/edit.png" title="Ver relatório"/></a>
	         </display:column>
	    </display:table>	      
    </div>
