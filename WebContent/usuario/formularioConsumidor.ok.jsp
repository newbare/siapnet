...
<div id="conteudo">
    <fieldset><legend><b>| <label class="lbTituloLegend">Cadastro de Consumidor</label> |</b></legend>
        ...
        <form method="post" action="usuario.gravarConsumidor.logic" onsubmit="return validaForm();">
            ...
            <table>
                ...
                <tr><td><label for="numeroMatricula">Matrícula:</label></td><td><input type="text" id="numeroMatricula" name="consumidor.numeroMatricula" value="${consumidor.numeroMatricula}" maxlength="15" /></td></tr>
